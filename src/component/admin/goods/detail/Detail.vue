<template>
    <div class="detail">
        ...
        <el-form ref="form" :model="form" label-width="80px" class="detail_form">
            <el-form-item label="内容标题" style="width:900px;">
                <el-input v-model="form.title"></el-input>
            </el-form-item>

            <el-form-item label="副标题" style="width:540px;">
            ...
            <el-form-item label="上传封面">
                ...
                <el-upload class="upload-demo" action="https://localhost:8899/admin/article/uploadimg" 
            ...
            <el-form-item label="上传附件">
                <el-upload class="upload-demo" action="https://localhost:8899/admin/article/uploadfile" :limit="3" :on-success="uploadfile" :file-list="form.fileList">
                    <el-button size="small" type="primary">点击上传</el-button>
